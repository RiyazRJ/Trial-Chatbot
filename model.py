...
data = pd.read_csv("C:\\Users\\rahmed3\Desktop\\Trial Chatbot\\BankFAQs - Copy.csv")
...
def get_response(usrText):
    while True:
        ...
        sd=["Thanks for visit to Inside AI Bank"]
       ...
       # r = [x.lower() for x in ty]
        ...
        if usrText.lower() in a:
            return ("Welcome to InsideAIBANK !\U0001F3E6")
...
def get_response2(usr):
    if usr.lower() == "bye":
        return "Thanks for visit to Inside AIBank! \U0001F64F"
    ...
    if usr.lower() in a:
        return ("You can ask Query related to : Accounts, Insurance, Funds, Cards etc.")
    ...
    if max(cos_sims) == [[0.]]:
        return "I'm not able to solve this question at this moment. You can call to customer care \U0001F615"
